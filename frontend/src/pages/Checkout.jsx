...
import { FiUser, FiPhone, FiMapPin, FiCreditCard, FiUpload, FiCheckCircle, FiAlertTriangle } from 'react-icons/fi';
...
const Checkout = () => {
  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      setSubmitError(error.response?.data?.message || 'Something went wrong while placing your order. Please try again.');
    } finally {
      setSubmitting(false);
    }
  };
